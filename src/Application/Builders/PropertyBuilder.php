...
class PropertyBuilder
{
    ...
    {
        if ('int' === $this->propertyName) {
            return new IntProperty(code: $this->code, value: $this->value, required: $this->requiredProperty);
        }
        if ('bool' === $this->propertyName) {
            return new StringProperty(code: $this->code, value: $this->value, required: $this->requiredProperty);
        }
        return new BoolProperty(code: $this->code, value: $this->value, required: $this->requiredProperty);
    }
}
